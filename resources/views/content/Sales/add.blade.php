                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                required  name='item_name' id='item_name'>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                required  name='item_code' id='item_code'>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                required  name='item_barcode' id='item_barcode'>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                required  name='last_balance' id='last_balance'>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                required  name='item_unit_cost' id='item_unit_cost'>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input placeholder="Masukkan Harga Beli Item" type="number" class='form-control'
                                required  name='item_unit_price' id='item_unit_price'>
                            </div>
                        </div>
